...
/**
 * Created by Wayne on 12/21/2014.
 */
...
public final class Constants {
    ...
    public static final float ANDROID_BUILDING_RADIUS_METERS = 2000f;
    */
    ...
    public static final float YERBA_BUENA_RADIUS_METERS = 2000f;

    // modified lat/long for my house
    public static final String ANDROID_BUILDING_ID = "1";
    public static final double ANDROID_BUILDING_LATITUDE = 32.78982;
    public static final double ANDROID_BUILDING_LONGITUDE = -117.0671;
    public static final float ANDROID_BUILDING_RADIUS_METERS = 245f;
    ...
    public static final String KEY_LATITUDE = "com.bloc.blocspot.KEY_LATITUDE";
    public static final String KEY_LONGITUDE = "com.bloc.blocspot.KEY_LONGITUDE";
    public static final String KEY_RADIUS = "com.bloc.blocspot.KEY_RADIUS";
    public static final String KEY_EXPIRATION_DURATION =
            "com.bloc.blocspot.KEY_EXPIRATION_DURATION";
    public static final String KEY_TRANSITION_TYPE =
            "com.bloc.blocspot.KEY_TRANSITION_TYPE";
    // The prefix for flattened geofence keys.
    public static final String KEY_PREFIX = "com.bloc.blocspot.KEY";
