...
/**
 * Created by Wayne on 12/13/2014.
 */
public class AllFavoritePlacesListFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>, TextWatcher {
    ...
    public static AllFavoritePlacesListFragment newInstance() {
        AllFavoritePlacesListFragment fragment = new AllFavoritePlacesListFragment();
    ...
    public AllFavoritePlacesListFragment() {
    }
