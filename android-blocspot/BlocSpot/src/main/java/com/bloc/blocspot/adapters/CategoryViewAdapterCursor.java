...
public class CategoryViewAdapterCursor extends SimpleCursorAdapter implements View.OnClickListener {
    ...
    public void bindView(View view, final Context context, Cursor cursor) {//this view is returned for method newview
        ...
        popupMenu.getMenu().add(Menu.NONE, 2, Menu.NONE, "Make this a favorite category");
    ...
    private void createFavCategory(final int mPosition) {
        ...
        categoriesDao.update(currentCategory);
        Message.message(context, "Category added to favorites");
    }
